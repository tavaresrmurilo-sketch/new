...
export const GET = apiRoute(async () => {
  ...
  const [tenant, users, dataSources, customers, suppliers, products, sellers, sales, saleItems, revenues, expenses, payables, receivables, payments, accounts, costCenters, chart, knowledge, insights, conversations, messages] = await Promise.all([
  ...
  const body = JSON.stringify({ exportedAt: new Date().toISOString(), tenant, users, dataSources, customers, suppliers, products, sellers, sales, saleItems, revenues, expenses, payables, receivables, payments, accounts, costCenters, chart, knowledge, insights, conversations, messages });
